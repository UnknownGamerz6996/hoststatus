<?php
/**
* Translation file for the monitoring system
*/
...
return [
   'en' => [
       ...
       'monitoringSystem' => 'Server Monitoring',
       'pageDescription' => 'Real-time server status monitoring dashboard',
       'refresh' => 'Refresh',
       ...
       'getUpdatesDescription' => 'Stay informed about our system status. We\'ll send you updates when there are changes or planned maintenance.',
   ...
   'ro' => [
       ...
       'monitoringSystem' => 'Monitorizare Servere',
       'pageDescription' => 'Panou de monitorizare a stării serverelor în timp real',
       ...
       'getUpdatesDescription' => 'Fii informat despre starea sistemului nostru. Îți vom trimite actualizări când apar schimbări sau mentenanță planificată.',
